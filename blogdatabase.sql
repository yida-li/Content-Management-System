...
CREATE TABLE `article` (
  ...
  `title` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `content` mediumtext CHARACTER SET utf8mb3 COLLATE utf8_bin,
...
CREATE TABLE `draft` (
  ...
  `createTime` datetime DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  `state` int DEFAULT '0' COMMENT '0=havent checked yet/1=declined',
  PRIMARY KEY (`did`),
  KEY `FK_D_UID` (`uid`),
  CONSTRAINT `FK_D_UID` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `draft` VALUES (1,1,0,'title1',NULL,'2022-07-25 17:02:56','2022-07-25 17:02:58',0),(2,2,1,'newtitle1',NULL,'2022-07-25 17:03:29','2022-07-25 17:03:31',0),(3,2,2,'newtitle2',NULL,'2022-07-25 17:04:26','2022-07-25 17:04:28',0);
...
CREATE TABLE `tag` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `password` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
